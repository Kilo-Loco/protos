...
public struct CreateMessageInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, senderName: String, body: String) {
    graphQLMap = ["id": id, "senderName": senderName, "body": body]
  }
...
public struct ModelMessageConditionInput: GraphQLMapConvertible {
  ...
  public init(senderName: ModelStringInput? = nil, body: ModelStringInput? = nil, and: [ModelMessageConditionInput?]? = nil, or: [ModelMessageConditionInput?]? = nil, not: ModelMessageConditionInput? = nil) {
    graphQLMap = ["senderName": senderName, "body": body, "and": and, "or": or, "not": not]
  }
...
public struct UpdateMessageInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, senderName: String? = nil, body: String? = nil) {
    graphQLMap = ["id": id, "senderName": senderName, "body": body]
  }
...
public struct ModelMessageFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, senderName: ModelStringInput? = nil, body: ModelStringInput? = nil, and: [ModelMessageFilterInput?]? = nil, or: [ModelMessageFilterInput?]? = nil, not: ModelMessageFilterInput? = nil) {
    graphQLMap = ["id": id, "senderName": senderName, "body": body, "and": and, "or": or, "not": not]
  }
...
public final class CreateMessageMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateMessage: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, senderName: String, body: String, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Message", "id": id, "senderName": senderName, "body": body, "createdAt": createdAt, "updatedAt": updatedAt])
      }
