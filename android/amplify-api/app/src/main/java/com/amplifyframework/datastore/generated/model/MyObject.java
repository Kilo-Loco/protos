...
@ModelConfig(pluralName = "MyObjects", authRules = {
...
public final class MyObject implements Model {
  ...
  private MyObject(String id, String value) {
    this.id = id;
    this.value = value;
  }
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), myObject.getId()) &&
              ObjectsCompat.equals(getValue(), myObject.getValue());
      }
  }
  ...
  public static class Builder implements ValueStep, BuildStep {
    private String id;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String value) {
      super.id(id);
      super.value(value);
    }
